...
assert.match(plist, /<key>CFBundleShortVersionString<\/key><string>1\.0\.1<\/string>/);
assert.match(piAdapter, /version: "1\.0\.1"/);
assert.match(windowsSetup, /\$Version = "1\.0\.1"/);
