...
pub fn ThemeMenu() -> Element {
    ...
    rsx! {
        div { class: "export-menu",
            button {
                class: "btn",
                title: "Pick a color palette and light/dark mode",
            ...
            if open() {
                ...
                div { class: "export-dropdown theme-dropdown",
                    div { class: "mode-row",
                        for (mode, label) in [
                            (Mode::Auto, "Auto"),
                            (Mode::Light, "Light"),
                            ...
                            button {
                                ...
                                onclick: {
                                    let cli = cli.clone();
                                    // Stays open: mode and palette are
                                    // usually picked in the same visit.
                                    move |_| {
